...
SMODS.Atlas{ -- Atlas for Booster Packs
	key = 'Boosters',
	path = 'Boosters.png',
	px = 71,
	py = 95
}
SMODS.Atlas{ -- Atlas for Sticker (singular)
	key = 'Stickers',
	path = 'Stickers.png',
	px = 71,
	py = 95
}
SMODS.Atlas{ -- Atlas for Tag (singular)
	key = "Tags",
	path = "Tags.png",
	px = 34,
	py = 34,
...
SMODS.Booster{
	...
	create_card = function(self, card)
		return SMODS.create_card({set = "Food", area = G.pack_cards, skip_materialize = true, key_append = "does rng seeding matter that much?"})
	end,
	weight = 0,
	cost = 0,
